public class Magpie2
{
	...
	public String getResponse(String statement)
	{
		...
		else
		{
		  ...
		  if(psn >= 0 && findKeyword(statement, "you", psn2) >=0)
		  {
	...
	*/
	private String transformIWantToStatement(String statement)
	{
	   ...
	   * return "What would it mean to" + restOfStatement; **/
	   ...
	   String want = "I want to";
	   int psn = findKeyword(statement, want);

		String restOfStatement = statement.substring(want.length(), statement.length());
	   return "What would it mean to" + restOfStatement + "?";
	}
